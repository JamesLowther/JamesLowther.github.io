...
const WriteupPage = ({ data }) => {
  ...
  return (
    <section className="bg-gray-900 w-full h-screen text-white" style={{"font-family": "'Roboto Mono', monospace"}}>
      <Helmet>
        <title>James Lowther - Writeups</title>
        <meta name="description" content="Writeups written by James Lowther" />
        <html lang="en" />
      </Helmet>
      <div class="flex absolute">
        <Link
          class="text-white mt-5 ml-4 shadow-lg transition duration-200 ease-in-out bg-gray-700 hover:bg-red-600 transform hover:-translate-y-1 hover:scale-110 rounded-lg py-2 px-8"
          to="/"
        >
          Back
        </Link>

    ...
    <div class="pt-8 pb-16 px-16">
      ...
      <div class="flex flex-col md:flex-row items-center">
        ...
        <div>
          ...
          <p class="text-white text-2xl mt-6 md:ml-16 md:mr-16">Take a look below at some of the projects I've been working on and check out my <a href="https://github.com/JamesLowther/" target="_blank" rel="noreferrer" class="underline text-purple-400">GitHub</a>!</p>
        </div>
      </div>

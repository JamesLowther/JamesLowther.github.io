    ...
    <div className="flex flex-col md:flex-row items-center bg-blue-900 bg-opacity-45 rounded-lg p-12">
      ...
      <div className="w-full md:w-2/3">
        ...
        <div className="text-center md:text-left mt-10">
          <a className="text-2xl text-white underline" href="https://infosecucalgary.ca/" target="_blank" rel="noreferrer">https://infosecucalgary.ca/</a>
        </div>
      </div>
    </div>
  )

    ...
    <div className="flex flex-col md:flex-row items-center bg-indigo-900 bg-opacity-45 rounded-lg p-12">
      <div className="w-full md:w-2/3">
        ...
        <p className="text-white text-2xl mb-8">
          ...
          <span className="text-pink-400">Watchtower</span>,{" "}
          <span className="text-pink-400">Terraform</span>,{" "}
          <span className="text-pink-400">DigitalOcean</span>,{" "}
          <span className="text-pink-400">Cloudflare</span>, and{" "}
          <span className="text-pink-400">Google Cloud</span>. Created

  ...
  return (
    <div className="flex flex-col md:flex-row items-center bg-teal-900 bg-opacity-45 rounded-lg p-12">
      ...
      <div className="w-full md:w-2/3">
        ...
        <p className="text-white text-2xl mb-8">Discord-driven attack-and-defend strategy game based around a medieval theme. Players would build a kingdom by settling villages. Attack and defence units could be purchased to attack other player's kingdoms. Complete with front-end scoreboard to track player status. Written with <span className="text-green-400">discord.py</span> for the back-end and <span className="text-green-400">flask</span> for the front-end website.</p>
        <div className="text-center md:text-left">
          <a className="text-2xl text-white underline" href="https://github.com/JamesLowther/rumpus-kingdoms" target="_blank" rel="noreferrer">GitHub repo</a>
        </div>
      </div>
    </div>
  );
